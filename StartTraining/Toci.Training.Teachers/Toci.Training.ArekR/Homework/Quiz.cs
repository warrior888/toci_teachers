...
namespace Toci.Training.ArekR.Homework
{
    public class Quiz
    {
        ...
        static Quiz()
        {
            ...
            foreach (QuestionAnswerEntityArek q in questionsAndAnswers)
            {
                Console.ForegroundColor = ConsoleColor.Gray;
                Console.WriteLine(q.Question);
                DisplayShuffledAnswers(q.AnswersList);
                #region wersja, w ktorej odpowiasz do skutku, ale punkt jest dodawany jesli odpowiesz prawidlowo za pierwszym razem
                score = CheckAnswer(q.AnswersList, score);
                #endregion
